export const CAFES_MITTE = [
  {
    id: "1",
    title: "The Barn Coffee Roasters",
    description: "Specialty coffee roastery with minimalist design and expert baristas. Known for their single-origin coffees and precise brewing methods.",
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Hidden gem in a beautiful courtyard serving excellent coffee and brunch. Popular among locals and tourists alike.",
    rating: 4.7,
